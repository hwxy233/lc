package com.hwxy.code.leetcode.order.l1100.l1001;
...
public class Lc1001 {
    ...
    /**
     * 将网格转换成一个坐标系，行下标作为 xx 坐标，列下标作为 yy 坐标。
     * 我们使用直线与坐标轴上交点的数值来唯一标识行，列和正/反对角线。相应的规则为：
     *
     * 对角线为 x - y
     * 反对角线为 x + y
     *
    ...
    public int[] gridIllumination(int n, int[][] lamps, int[][] queries) {
        ...
        for (int[] lamp : lamps) {
            ...
            antiDiagonal.put(lamp[0] + lamp[1],
                    antiDiagonal.getOrDefault(lamp[0] + lamp[1], 0) + 1);
        }
